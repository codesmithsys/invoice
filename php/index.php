    ...
    <main class="container-center">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <span class="value green">$<?= number_format($totalRevenue, 2) ?></span>
            </div>
            <div class="stat-card">
                <span class="label">Pending</span>
                <span class="value blue">$<?= number_format($totalPending, 2) ?></span>
            </div>
            <div class="stat-card">
                <span class="label">Overdue</span>
                <span class="value red">$<?= number_format($totalOverdue, 2) ?></span>
            </div>
            <div class="stat-card">
        ...
        <table class="invoice-table" id="invoiceTable">
            ...
            <tbody>
                ...
                if (empty($invoices)) {
                    echo '<tr><td colspan="7" class="empty-state">No invoices yet. <a href="create.php">Create your first invoice</a></td></tr>';
                } else {
                    foreach ($invoices as $inv) {
                        ...
                        echo '<td><strong>'.htmlspecialchars($inv['invoice_number']).'</strong></td>';
                        ...
                        echo '<a href="view.php?id='.$inv['id'].'" class="btn btn-sm btn-ghost" title="View"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></a> ';
                        echo '<a href="create.php?id='.$inv['id'].'" class="btn btn-sm btn-ghost" title="Edit"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a> ';
                        echo '<a href="delete.php?id='.$inv['id'].'" class="btn btn-sm btn-ghost" title="Delete" onclick="return confirm(\'Delete this invoice?\')"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></a>';
                        echo '</td></tr>';
                    }
                }
                ?>
